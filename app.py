...
BOT_NAME="boombox_v4"   # used for DB, do not absolutely change or you will lose access to prefixes previously changed by servers using this bot
...
TESTING_SERVERS=[940590432105152513, 941233178729938955]
data = {}

# SET LOGGING
logger = logging.getLogger('discord')
logger.setLevel(logging.DEBUG)
handler = logging.FileHandler(filename=f'{BOT_NAME}.log', encoding='utf-8', mode='w')    # dump logs to boombox_v4.log
